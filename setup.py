	...
	setup(
		...
		entry_points={
			"console_scripts": [
				...
				"collate_counts=gqlib.bin.collate_counts:main",
				# "split_table=gqlib.bin.split_table:main",
				"build_gene_database=gqlib.bin.build_gene_database:main",
				"build_domain_database=gqlib.bin.build_domain_database:main",
				"build_bed_database=gqlib.bin.build_bed_database:main",
				"build_custom_database=gqlib.bin.build_custom_database:main",
				"collate_studies=gqlib.bin.collate_studies:main",
				# "db_collate=gqlibt.bin.db_collate:main",
			],
		},
		package_data={},
